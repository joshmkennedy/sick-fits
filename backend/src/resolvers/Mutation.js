...
const Mutations = {
    ...
    async addToCart(parent, args, ctx, info){
        ...
        // check item is already in cart item if so inctrement by 1
        if (existingCartItem){
   ...
   async removeFromCart(parent, args, ctx, info){
    ...
    if(cartItem.user.id !== ctx.request.userId){
        throw new Error('dont have permission to delete cart item')
    }
    //delete cartItem
