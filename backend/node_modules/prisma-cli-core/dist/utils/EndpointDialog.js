...
var EndpointDialog = /** @class */ (function () {
    ...
    EndpointDialog.prototype.handleChoice = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var clusterEndpoint, cluster, workspace, service, stage, credentials, dockerComposeYml, datamodel, newDatabase, managementSecret, writeDockerComposeYml, _c, needsAuth, type, _d, defaultHosts, before, client, connector, introspector, schemas, e_1, schema, _e, numTables, sdl, demoCluster, result_1, _f, _g, generator, _h;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 13:
                        credentials = _j.sent();
                        if (!(credentials.type !== 'mongo')) return [3 /*break*/, 21];
                        this.out.log('');
                        before = Date.now();
    ...
    EndpointDialog.prototype.getDatabase = function (introspection) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var type, alreadyData, _a, _b, askForSchema, host, port, user, password, database, _c, ssl, _d, schema, _e;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0: return [4 /*yield*/, this.askForDatabaseType(introspection)];
                    case 1:
                        type = _f.sent();
                        if (!(type === 'mongo')) return [3 /*break*/, 2];
                        _a = false;
                        return [3 /*break*/, 5];
                    case 2:
                        _b = introspection;
                    ...
                    case 9:
                        password = _f.sent();
                        if (!(type === 'postgres')) return [3 /*break*/, 11];
                        return [4 /*yield*/, this.ask({
                                message: alreadyData
                    ...
                    case 12:
                        database = _c;
                        if (!(type === 'postgres')) return [3 /*break*/, 14];
                        return [4 /*yield*/, this.ask({
                                message: 'Use SSL?',
                                inputType: 'confirm',
                                key: 'ssl',
                    ...
                    case 15:
                        ssl = _d;
                        if (!askForSchema) return [3 /*break*/, 17];
                        return [4 /*yield*/, this.ask({
