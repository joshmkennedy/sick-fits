...
var GenereateCommand = /** @class */ (function (_super) {
    ...
    GenereateCommand.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var envFile, before, schemaString, serviceName, stageName, token, cluster, workspace, databaseType, _i, _a, _b, generator, output, resolvedOutput, internalTypes, generators;
                ...
                switch (_c.label) {
                    ...
                    case 6:
                        databaseType = this.definition.definition.databaseType === 'document'
                            ? prisma_generate_schema_1.DatabaseType.document
                            : prisma_generate_schema_1.DatabaseType.relational;
                    ...
                    case 11:
                        ...
                        _c.label = 12;
                    case 12:
                        internalTypes = prisma_generate_schema_1.parseInternalTypes(this.definition.typesString, prisma_generate_schema_1.DatabaseType.relational);
